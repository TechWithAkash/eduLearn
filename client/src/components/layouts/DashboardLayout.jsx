  ...
  const sidebarLinks = () => {
    if (user.role === 'student') {
      ...
      return [
        { name: 'Dashboard', path: '/dashboard', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
        { name: 'My Courses', path: '/dashboard/my-courses', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
        { name: 'Course Manager', path: '/dashboard/course-manager', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
        // { name: 'Assignment Manager', path: '/dashboard/assignment-manager', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
        // { name: 'Quiz Manager', path: '/dashboard/quiz-manager', icon: 'M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
        // { name: 'Students', path: '/dashboard/students', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
        // { name: 'Analytics', path: '/dashboard/courses/analytics', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
        { name: 'Profile', path: '/dashboard/profile', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
      ];
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <nav className="mt-5 px-2">
          ...
          <button
  onClick={handleLogout}
  className="flex items-center justify-center w-full px-5 py-3 text-sm font-semibold text-red-500 bg-red-100 rounded-xl transition-all duration-300 hover:bg-red-500 hover:text-white shadow-md"
>
              <svg className="w-5 h-5 mr-2 text-red-400 hover:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
              </svg>
              Logout
            </button>
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        <header className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 bg-white shadow-sm">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative flex items-center">
              <div className={`flex-shrink-0 rounded-full p-1 text-white font-semibold h-8 w-8 flex items-center justify-center ${
                user?.role === 'admin' ? 'bg-purple-500' : 
                user?.role === 'tutor' ? 'bg-green-500' : 
                'bg-blue-500'
              }`}>
                {user?.name?.charAt(0).toUpperCase() || 'U'}
              </div>
